...
if __name__ == "__main__":
    ...
    #question = ("Read Day_3/notice.html and tell what is 15% of the AI202 fee? ")
    #question = ("Read Day_3/notice.html and tell Hostel student, all three courses, including laboratory changes.")
    question=("Read fees.html and tell me the fees for CS101.")
    print("Q:", question)
